...
export default function Projects() {
  return (
    ...
    <ul className="grid grid-cols-4 gap-x-12 gap-y-16 mt-8  ml-8  ">
...
py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">Github</span>
                    </div>
                </div>
            </a>
        </li>
            ...
            <a href="https://github.com/claudiuib/web-scrapper-caps">
                <div className="max-w-sm rounded overflow-hidden shadow-lg">
                    ...
                    <Image className='rounded-md' src={Caps} alt='Crypto Image'/>
                        <div className="font-bold text-xl mb-2">Caps Web Scrapper Website</div>
                    </div>
